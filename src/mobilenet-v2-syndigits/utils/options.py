...
parser.add_argument('--dataset', type = str, default = 'syndigits', help = 'Dataset to train')
parser.add_argument('--lt_gamma', type = int, default = GAMMA)
parser.add_argument('--lt_loss', type = str, default = LOSS)

parser.add_argument('--data_dir', type = str, default = '/home/tingan123/dataset/syndigits/', help = 'The directory where the input data is stored.')
parser.add_argument('--csv_dir', type = str, default = 'data/syndigits/', help = 'The directory where the input data is stored.')
...
parser.add_argument('--target_model', type = str, default = 'mobile_v2', help = 'The target model.')

parser.add_argument('--source_model', type = str, default = 'mobile_v2', help = 'The baseline model.') 
