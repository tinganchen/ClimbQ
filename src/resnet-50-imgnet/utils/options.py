...
parser.add_argument('--train_data_dir', type = str, default = '/home/tingan123/dataset/imagenet/', help = 'The directory where the input data is stored.')
parser.add_argument('--test_data_dir', type = str, default = '/work/tingan123/dataset/imagenet/', help = 'The directory where the input data is stored.')
#parser.add_argument('--data_dir', type = str, default = '/home/tachen/dataset/imagenet/', help = 'The directory where the input data is stored.')
parser.add_argument('--csv_dir', type = str, default = 'data/imagenet/', help = 'The directory where the input data is stored.')
...
parser.add_argument('--class_num_dir', type = str, default = 'data/num_cls_data/', help = 'The directory where the input data is stored.')
...
parser.add_argument('--cal_num_samples', action = 'store_true', default = CAL_SAMPLES, help = 'Load pruned model')
...
parser.add_argument('--num_classes', type = int, default = 1000, help = 'The num of classes to train.') # 100
...
parser.add_argument('--lr', type = float, default = 0.04) # 0.04
...
parser.add_argument('--lr_decay_step', type = int, default = 25)
parser.add_argument('--lr_decay_steps', type = list, default = [25, 50, 75])
# 1. train: default = 30
...
## Status
parser.add_argument('--print_freq', type = int, default = 1000, help = 'The frequency to print loss.')
