...
class CIFAR10_LT(Dataset):
    def __init__(self, args, root, train, transform):
        ...
        self.root = root
        if train:
            data_csv = self.root + f'cifar10_train{args.lt_gamma}.csv'
        else:
            data_csv = self.root + 'cifar10_test.csv'
...
class Data:
    def __init__(self, args):
        ...
        trainset = CIFAR10_LT(args=args, root=args.csv_dir, train=True, transform=transform_train)
        ...
        testset = CIFAR10_LT(args=args, root=args.csv_dir, train=False, transform=transform_test)
