...
METHOD = 'ours' # data_free_kd, kd_kl
LOSS = ''
GAMMA = 50
BIT = 4
...
parser.add_argument('--data_dir', type = str, default = '/home/tingan123/dataset/cifar10/', help = 'The directory where the input data is stored.')
parser.add_argument('--csv_dir', type = str, default = 'data/cifar10/', help = 'The directory where the input data is stored.')
